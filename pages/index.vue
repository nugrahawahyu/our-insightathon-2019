        ...
        <section v-show="showSlide2" ref="slide2" class="section scene-slide z-index-2" style="background: #fff; color: white;">
          <div class="container full-height container-no-margin">
            <interactive-section>
              ...
              <timeline ref="timeline" :scroll-top="scrollTop" :timeline-items="timelineItems" @end-of-section="onEndOfSection" @click="onTimelineClick" />
            </interactive-section>
          </div>
        </section>
      </transition>
          ...
          <div class="container full-height align-top-section-container">
            <plain-section>
              ...
              <div class="last-column">
                ...
                <div style="position: absolute; left: 0; right: 0; bottom: -24px; z-index: 10;">
                  <bl-button @click.native="nextStory = !nextStory" v-html="!nextStory ? `Selanjutnya <img src='/images/ic_arrow_next.png' style='margin: -6px 0 -8px 4px; width: 24px;'>` : 'Kembali ke sebelumnya'" />
                </div>
              </div>
...
export default {
  ...
  methods: {
    ...
    updateCurrentSection(scrollTop = 0) {
      if (scrollTop < 800) {
      ...
      if (scrollTop > 1200 && scrollTop <= 4800) {
    ...
    onTimelineClick(itemId) {
      if (itemId === 1) {
        ...
        document.documentElement.scrollTop = document.body.scrollTop = 2002
      } else if (itemId === 3) {
        document.documentElement.scrollTop = document.body.scrollTop = 3433
      }
    }
  }
}
